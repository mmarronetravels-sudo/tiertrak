...
const operatorAcademicCalendarRoutes = require('./routes/operatorAcademicCalendar');
const schoolAcademicCalendarRoutes = require('./routes/schoolAcademicCalendar');
...
const districtAcademicCalendarRoutes = require('./routes/districtAcademicCalendar');
const districtSchoolsRoutes = require('./routes/districtSchools');
const districtDashboardRoutes = require('./routes/districtDashboard');
const districtReportRoutes = require('./routes/districtReport');
...
const studentGradeRollupRoutes = require('./routes/studentGradeRollup');
...
const createTables = async () => {
  try {
    ...
    // Seed test users (only if they don't exist) — never in production.
...
app.use('/api/intervention-logs', requireAuth, interventionLogsRoutes);
...
app.use('/api/intervention-assignments', requireAuth, interventionAssignmentsRoutes);
app.use('/api/parent-links', parentLinksRoutes);
app.use('/api/admin', requireAuth, adminTemplatesRoutes);
app.use('/api/intervention-plans', requireAuth, interventionPlansRoutes);
app.use('/api/student-documents', studentDocumentsRoutes);
app.use('/api/staff', authIpLimiter, staffManagementRoutes);
app.use('/api/intervention-bank', requireAuth, interventionBankRoutes);
...
app.use('/api/districts', districtAcademicCalendarRoutes);
app.use('/api/districts', districtSchoolsRoutes);
...
app.use('/api/operator/academic-calendar', operatorAcademicCalendarRoutes);
app.use('/api/school/academic-calendar', schoolAcademicCalendarRoutes);
...
app.use('/api/student-grade-rollup', studentGradeRollupRoutes);
