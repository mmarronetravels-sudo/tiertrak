...
> **⚠️ Superseded by `docs/scoping-v2.md` (Session 23 follow-up, April 19, 2026).**
> v1 is retained for historical reference only. Do not implement from v1 —
> several architectural assumptions (URL routing, static asset path,
> parenthetical detection approach) were found incorrect during the
> Session 24 router-verification pass and revised in v2.
> See `docs/scoping-v2.md` §13 for the full delta.
